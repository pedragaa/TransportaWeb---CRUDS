...
const insertMotorista =  async function(dadosMotorista) {
    ...
    try {
     ...
     let sql  = `insert into tbl_motorista( nome, foto_url, data_nascimento, cpf, email, senha ) values ('${dadosMotorista.nome}', '${dadosMotorista.foto_url}',  '${dadosMotorista.data_nascimento}',  '${dadosMotorista.cpf}', '${dadosMotorista.email}',  '${dadosMotorista.senha}' )`
...
const updateMotorista =  async function(id, dadosMotorista) {
    ...
    try {
        ...
        sql = `update tbl_motorista set nome = '${dadosMotorista.nome}', foto_url = '${dadosMotorista.foto_url}',  '${dadosMotorista.data_nascimento}', cpf = '${dadosMotorista.cpf}', email = '${dadosMotorista.email}', senha = '${dadosMotorista.senha}' where id = ${id}`
