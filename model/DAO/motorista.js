...
const insertMotorista =  async function(dadosMotorista) {
    ...
    try {
     ...
     let sql  = `insert into tbl_motorista( nome, foto_url, data_nascimento, cpf, email, senha, disponibilidade_status ) values ('${dadosMotorista.nome}', '${dadosMotorista.foto_url}',  '${dadosMotorista.data_nascimento}',  '${dadosMotorista.cpf}', '${dadosMotorista.email}',  '${dadosMotorista.senha}', '${dadosMotorista.disponibilidade_status}' )`
...
const updateMotorista =  async function(id, dadosMotorista) {
    ...
    try {
        ...
        sql = `update tbl_motorista set nome = '${dadosMotorista.nome}', foto_url = '${dadosMotorista.foto_url}',  '${dadosMotorista.data_nascimento}', cpf = '${dadosMotorista.cpf}', email = '${dadosMotorista.email}', senha = '${dadosMotorista.senha}', disponibilidade_status = '${dadosMotorista.disponibilidade_status}' where id = ${id}`
